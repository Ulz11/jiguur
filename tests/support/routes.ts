 ...
 *
 * Тиймээс ЗӨВХӨН «бэлэн үү» гэсэн хаалганууд нь навигацийн төсөвтэй явна.
 * Хуудсан дээрх БҮХ бодит баталгаа 10 секундэд хэвээр.
 *
 * POM-ууд ч мөн үүнийг хэрэглэнэ: `ContractDetailPage.goto()` нь
 * `page.goto`-той ЗЭРЭГ (`Promise.all`) серверийн хариуг хүлээдэг — тэр
 * хүлээлт нь НАВИГАЦИЙН хэсэг мөн атлаа `actionTimeout` (10с) дээр үлдсэн
 * байв. `--repeat-each=3` дээр (1008 гүйлт) НЭГ удаа тэндээ таслагдав.
 * Хариу нь `r.ok()` шаардсан ХЭВЭЭР — зөвхөн ТЭВЧЭЭР нь навигацийнхтай
 * тэнцлээ.
 */
export const READY_MS = 45_000;
