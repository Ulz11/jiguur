...
export const ALLOWED: Allowance[] = [
  ...
  /* ---------- 2b. ТАТАГДАХ ФАЙЛЫН ЯГ НЭР ----------
     ⚠ ӨРГӨТГӨВ (2026-09). «⇩ Excel татах» гэдэг товч ЯМАР нэртэй файл
     буулгахыг хэлдэггүй байв: сервер `tailan.xlsx` гэж илгээдэг атал дэлгэц
     нь өөр нэр (`jiguur-tailan.xlsx`) амлаж байсан. Отгоо татсан файлаа
     «Downloads» дотроос НЭРЭЭР нь хайдаг — нэр нь зөрвөл тэр файл алга
     болсонтой адил. Файлын нэр орчуулагддаггүй: диск дээр ЯГ ийм байна,
     орчуулбал л хайлт нь бүтэхгүй болно (`Excel`, `PDF` мөрүүдтэй нэг үндэс).
     Хэв нь маш нарийн — жижиг үсэг ба `.xlsx`/`.pdf` төгсгөл. */
  { re: /\b[a-z][a-z0-9_-]*\.(?:xlsx|pdf)\b/g,
    why: 'татагдах файлын ЯГ нэр — Отгоо түүнийг Downloads дотроос нэрээр нь хайдаг' },
