...
export class ContractDetailPage {
  ...
  /**
   * Толгойн үзүүлэлт («Энэ гэрээний үлдэгдэл», «Өдрийн дүн» …) — нэрээрээ.
   *
  ...
  /** «Энэ гэрээний үлдэгдэл» — менежерийн хувьд бүтэн ₮-өөр ил зогсоно.
   *
   *  Шошго нь «Нийт үлдэгдэл» байсныг СОЛИВ (2026-09): ЯГ тэр нэр
   *  харилцагчийн хуудсан дээр ӨӨР тоон дээр (бүх гэрээ + хуучин үлдэгдэл)
   *  зогсдог тул «юуны нийт вэ» гэсэн асуулт үлддэг байв. */
  async balanceExact(): Promise<number> {
    const block = this.metric('Энэ гэрээний үлдэгдэл');
    await expect(block, '«Энэ гэрээний үлдэгдэл» үзүүлэлт алга').toBeVisible();
