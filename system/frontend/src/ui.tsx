...
export function ConfirmModal({ title, intro, rows, total, note, children, confirmDisabled,
   ...
   *  «Болих» дээр очно. Устгах/олгох/цуцлах гэх мэт ЭРГЭЖ БУЦАХГҮЙ үйлдэлд
   *  фокус гүйцэтгэх товч дээр байвал БУРУУ: Отгоо жагсаалт дундуур Enter
   *  дараад 5,950,000₮ цалин олгочихно.
   *
   *  ЗАВСРЫН АНГИЛАЛ бий: «Ачилт баталгаажуулах» нь буцаагддаггүй (зөвхөн
   *  цуцлалт) ч ӨДӨР ТУТМЫН хэвийн үйлдэл. Тэнд `note` нь «буцаах боломжгүй»
   *  гэж ил хэлдэг боловч `danger` АВАХГҮЙ: улаан бол «хэтэрсэн · акт ·
   *  устгах»-ын өнгө (UI-ЗАРЧИМ §4) — өдөрт олон удаа улаан товч дарвал улаан
   *  утгаа алдана. Тиймээс доорх шалгалт нь ХҮЧТЭЙ хэлбэрүүдийг л барина
   *  («буцаагдахгүй», «сэргэхгүй» — `lib/danger.ts`), «буцаах боломжгүй»
   *  гэсэн МЭДЭЭЛЛИЙН өгүүлбэрийг барихгүй.
   *
