...
describe("явдлын нэр", () => {
  ...
  it("танихгүй төрөл чимээгүй алга болохгүй — өөрөө гарна", () => {
    // ЧАНГАРУУЛСАН (2026-09): урьд нь түүхий түлхүүрээ буцаадаг байв.
    // Танихгүй бичилт нь ихэвчлэн серверийн АНГЛИ түлхүүр — тэр нь Отгоо
    // эгчийн нүдэнд хоосон нүд. Одоо монгол үг рүү зөөлөн унана.
    expect(depositKindLabel("шинэ")).toBe("Бусад");
  });
});
