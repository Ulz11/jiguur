...
describe("lotOptions", () => {
  ...
  /* ДАРГАД ТАРИФ ГАРАХГҮЙ. Түүний дэлгэц дээр үнэ хаа сайгүй хумигдсан байтал
     ЯГ энэ сонголтын мөр «110₮» гэж ил гаргадаг байв. Падан нь дугаар ба
     огноогоороо танигдана — тариф нь тэр шийдвэрт хэрэггүй. */
  it("үйлдвэрийн даргад тариф ХАСАГДАНА, падан нь танигдсан хэвээр", () => {
    expect(lotOptions(lots, "2026-04-10", 20, false)).toEqual([
      ["0", "Авто — эхлээд хуучнаас"],
      ["11", "#11 · 2026-03-20 · 100ш үлдсэн"],
      ["12", "#12 · 2026-04-05 · 50ш үлдсэн"],
    ]);
  });

  it("менежер, санхүүчид тариф ХЭВЭЭР (анхдагч нь «харна»)", () => {
    expect(lotOptions(lots, "2026-04-10", 20, true))
      .toEqual(lotOptions(lots, "2026-04-10", 20));
    expect(lotOptions(lots, "2026-04-10", 20, true)[1][1]).toContain("330₮");
  });
});
