...
describe("partnerSince — «Хамтран ажилласан» нь ХАМГИЙН ХУУЧИН гэрээнээс", () => {
  ...
  it("гэрээгүй бол бүртгэсэн огноо руу унана", () => {
    expect(partnerSince([], "2026-09-04")).toBe("2026-09-04");
    expect(partnerSince(null, "2026-09-04")).toBe("2026-09-04");
    expect(partnerSince([{ no: "OB-9", state: "opening", start_date: "2026-09-01" }],
                        "2026-09-04")).toBe("2026-09-04");
  });
});
