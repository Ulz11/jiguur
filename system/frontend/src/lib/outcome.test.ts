...
describe("saleOutcome · payOutcome · shipmentOutcome", () => {
  ...
  /* ДАШБОАРД дээр зургаан гэрээний ачилт зэрэгцэж зогсоно — аль нь
     баталгаажсаныг нэрлээгүй зурвас нь «дараад юу ч болсонгүй»-тэй адил. */
  it("хэний ачилт болохыг нэрлэж чадна (дашбоардын жагсаалт)", () => {
    expect(shipmentOutcome({ who: "Батбаяр ХХК — №R-26/07", qty: 25,
                             date: "2026-09-05", movementId: 5 }).text)
      .toBe("Ачилт баталгаажлаа — Батбаяр ХХК — №R-26/07 · 25ш · "
            + "2026-09-05-наас тооцоонд орлоо");
  });

  it("мөрүүд нь татагдаагүй бол «0ш» гэж ХУДАЛ бичихгүй", () => {
    expect(shipmentOutcome({ who: "Батбаяр ХХК", date: "2026-09-05" }).text)
      .toBe("Ачилт баталгаажлаа — Батбаяр ХХК · 2026-09-05-наас тооцоонд орлоо");
    expect(shipmentOutcome({ qty: null, date: "2026-09-05" }).text)
      .toBe("Ачилт баталгаажлаа — 2026-09-05-наас тооцоонд орлоо");
  });
});
