...
def test_factory_sees_the_material_page_with_rates(client, as_role):
    """Агуулах бол даргын талбай — хуудас нээгдэж, тариф нь хариунд ирнэ.

    ⚠ Энэ тест ХЭЗЭЭ Ч ЗӨРӨӨГҮЙ, гэхдээ тайлбар нь хуучирсан байв: нэгэн үе
    гэрээний дэлгэрэнгүй нь даргаас мөнгийг СЕРВЕР дээр хасдаг байсан тул
    энэ хуудас «зураасны гадна» гэж тэмдэглэгдсэн байлаа. Тэр зураас
    2026-09-д эзний шийдвэрээр УСТСАН (tests/test_money_tidy.py): дарга
    хаана ч мөнгийг УНШИНА, эмх цэгц нь харагдацын ажил
    (`Warehouse.tsx`/`MaterialDetail.tsx` — хумигдсан «Санхүү» задаргаа).
    """
